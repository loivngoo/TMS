	...
	<div class="chart-screen">
		<v-app>
			<v-row>
				<v-col lg="3" sm="6" class="total-idea">
					<v-card>
						<v-btn block color="#F1DE94" class="darken-1">
							...
							<span>{{ 'Total Project: ' + totalIdea }}</span>
						</v-btn>
					</v-card>
				</v-col>
				...
				<v-col lg="3" sm="6" class="total-client">
					<v-card>
						<v-btn block color="#8479E1" class="darken-1">
							<v-icon left color="white">fas fa-building</v-icon>
							<span class="text-white">{{ 'Total Client: ' + totalClient }}</span>
						</v-btn>
					</v-card>
				</v-col>
				...
				<v-col lg="3" sm="6" class="total-category">
					<v-card>
						<v-btn block color="#A3E4DB" class="darken-1">
							...
							<span>{{ 'Total Timesheet: ' + totalCategory }}</span>
						</v-btn>
					</v-card>
				</v-col>
			</v-row>
				...
				<v-col cols="6" class="like-per-idea-chart">
					<v-card>
						<v-card-text class="text-center">
							...
							<span>Top 5 most performing employees</span>
				...
				<v-col cols="6" class="dislike-per-idea-chart">
					<v-card>
						<v-card-text class="text-center">
							...
							<span>Top 5 underperforming employees</span>
...
export default {
    ...
    computed: {
        ...
        totalClient() {
            return this.$store.getters.totalClient;
        },
